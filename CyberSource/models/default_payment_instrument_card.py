...
class DefaultPaymentInstrumentCard(object):
    """
    ...
    def __init__(self, expiration_month=None, expiration_year=None, type=None, issue_number=None, start_month=None, start_year=None, use_as=None, hash=None, tokenized_information=None):
        """
        DefaultPaymentInstrumentCard - a model defined in Swagger
        """
    ...
    def expiration_month(self):
        """
        Gets the expiration_month of this DefaultPaymentInstrumentCard.
        Two-digit month in which the payment card expires.  Format: `MM`.  Possible Values: `01` through `12`. 

        :return: The expiration_month of this DefaultPaymentInstrumentCard.
        :rtype: str
        """
    ...
    def expiration_month(self, expiration_month):
        """
        Sets the expiration_month of this DefaultPaymentInstrumentCard.
        Two-digit month in which the payment card expires.  Format: `MM`.  Possible Values: `01` through `12`. 

        :param expiration_month: The expiration_month of this DefaultPaymentInstrumentCard.
        :type: str
        """
    ...
    def expiration_year(self):
        """
        Gets the expiration_year of this DefaultPaymentInstrumentCard.
        Four-digit year in which the credit card expires.  Format: `YYYY`. 

        :return: The expiration_year of this DefaultPaymentInstrumentCard.
        :rtype: str
        """
    ...
    def expiration_year(self, expiration_year):
        """
        Sets the expiration_year of this DefaultPaymentInstrumentCard.
        Four-digit year in which the credit card expires.  Format: `YYYY`. 

        :param expiration_year: The expiration_year of this DefaultPaymentInstrumentCard.
        :type: str
        """
    ...
    def type(self):
        """
        Gets the type of this DefaultPaymentInstrumentCard.
        ...
        :return: The type of this DefaultPaymentInstrumentCard.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this DefaultPaymentInstrumentCard.
        Value that indicates the card type. Possible Values v2 : v1:   * 001 : visa   * 002 : mastercard - Eurocard—European regional brand of Mastercard   * 003 : american express   * 004 : discover   * 005 : diners club   * 006 : carte blanche   * 007 : jcb   * 008 : optima   * 011 : twinpay credit   * 012 : twinpay debit   * 013 : walmart   * 014 : enRoute   * 015 : lowes consumer   * 016 : home depot consumer   * 017 : mbna   * 018 : dicks sportswear   * 019 : casual corner   * 020 : sears   * 021 : jal   * 023 : disney   * 024 : maestro uk domestic   * 025 : sams club consumer   * 026 : sams club business   * 028 : bill me later   * 029 : bebe   * 030 : restoration hardware   * 031 : delta online — use this value only for Ingenico ePayments. For other processors, use 001 for all Visa card types.   * 032 : solo   * 033 : visa electron   * 034 : dankort   * 035 : laser   * 036 : carte bleue — formerly Cartes Bancaires   * 037 : carta si   * 038 : pinless debit   * 039 : encoded account   * 040 : uatp   * 041 : household   * 042 : maestro international   * 043 : ge money uk   * 044 : korean cards   * 045 : style   * 046 : jcrew   * 047 : payease china processing ewallet   * 048 : payease china processing bank transfer   * 049 : meijer private label   * 050 : hipercard — supported only by the Comercio Latino processor.   * 051 : aura — supported only by the Comercio Latino processor.   * 052 : redecard   * 054 : elo — supported only by the Comercio Latino processor.   * 055 : capital one private label   * 056 : synchrony private label   * 057 : costco private label   * 060 : mada   * 062 : china union pay   * 063 : falabella private label 

        :param type: The type of this DefaultPaymentInstrumentCard.
        :type: str
        """
    ...
    def issue_number(self):
        """
        Gets the issue_number of this DefaultPaymentInstrumentCard.
        Number of times a Maestro (UK Domestic) card has been issued to the account holder. The card might or might not have an issue number. The number can consist of one or two digits, and the first digit might be a zero. When you include this value in your request, include exactly what is printed on the card. A value of 2 is different than a value of 02. Do not include the field, even with a blank value, if the card is not a Maestro (UK Domestic) card.  **Note** The issue number is not required for Maestro (UK Domestic) transactions. 

        :return: The issue_number of this DefaultPaymentInstrumentCard.
        :rtype: str
        """
    ...
    def issue_number(self, issue_number):
        """
        Sets the issue_number of this DefaultPaymentInstrumentCard.
        Number of times a Maestro (UK Domestic) card has been issued to the account holder. The card might or might not have an issue number. The number can consist of one or two digits, and the first digit might be a zero. When you include this value in your request, include exactly what is printed on the card. A value of 2 is different than a value of 02. Do not include the field, even with a blank value, if the card is not a Maestro (UK Domestic) card.  **Note** The issue number is not required for Maestro (UK Domestic) transactions. 

        :param issue_number: The issue_number of this DefaultPaymentInstrumentCard.
        :type: str
        """
    ...
    def start_month(self):
        """
        Gets the start_month of this DefaultPaymentInstrumentCard.
        ...
        :return: The start_month of this DefaultPaymentInstrumentCard.
        :rtype: str
        """
    ...
    def start_month(self, start_month):
        """
        Sets the start_month of this DefaultPaymentInstrumentCard.
        Month of the start of the Maestro (UK Domestic) card validity period. Do not include the field, even with a blank value, if the card is not a Maestro (UK Domestic) card. `Format: MM`. Possible Values: 01 through 12.  **Note** The start date is not required for Maestro (UK Domestic) transactions. 

        :param start_month: The start_month of this DefaultPaymentInstrumentCard.
        :type: str
        """
    ...
    def start_year(self):
        """
        Gets the start_year of this DefaultPaymentInstrumentCard.
        ...
        :return: The start_year of this DefaultPaymentInstrumentCard.
        :rtype: str
        """
    ...
    def start_year(self, start_year):
        """
        Sets the start_year of this DefaultPaymentInstrumentCard.
        Year of the start of the Maestro (UK Domestic) card validity period. Do not include the field, even with a blank value, if the card is not a Maestro (UK Domestic) card. `Format: YYYY`.  **Note** The start date is not required for Maestro (UK Domestic) transactions. 

        :param start_year: The start_year of this DefaultPaymentInstrumentCard.
        :type: str
        """
    ...
    def use_as(self):
        """
        Gets the use_as of this DefaultPaymentInstrumentCard.
        'Payment Instrument was created / updated as part of a pinless debit transaction.' 

        :return: The use_as of this DefaultPaymentInstrumentCard.
        :rtype: str
        """
        return self._use_as
    ...
    def use_as(self, use_as):
        """
        Sets the use_as of this DefaultPaymentInstrumentCard.
        'Payment Instrument was created / updated as part of a pinless debit transaction.' 

        :param use_as: The use_as of this DefaultPaymentInstrumentCard.
        :type: str
        """
    ...
    def hash(self):
        """
        Gets the hash of this DefaultPaymentInstrumentCard.
        Hash value representing the card. 

        :return: The hash of this DefaultPaymentInstrumentCard.
        :rtype: str
        """
        return self._hash
    ...
    def hash(self, hash):
        """
        Sets the hash of this DefaultPaymentInstrumentCard.
        Hash value representing the card. 

        :param hash: The hash of this DefaultPaymentInstrumentCard.
        :type: str
        """
    ...
    def tokenized_information(self):
        """
        Gets the tokenized_information of this DefaultPaymentInstrumentCard.

        :return: The tokenized_information of this DefaultPaymentInstrumentCard.
        :rtype: DefaultPaymentInstrumentCardTokenizedInformation
        """
    ...
    def tokenized_information(self, tokenized_information):
        """
        Sets the tokenized_information of this DefaultPaymentInstrumentCard.

        :param tokenized_information: The tokenized_information of this DefaultPaymentInstrumentCard.
        :type: DefaultPaymentInstrumentCardTokenizedInformation
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, DefaultPaymentInstrumentCard):
            return False
