...
class Ucv1sessionsDataProcessingInformationAuthorizationOptionsInitiator(object):
    """
    ...
    def __init__(self, credential_stored_on_file=None, merchant_initiated_transaction=None):
        """
        Ucv1sessionsDataProcessingInformationAuthorizationOptionsInitiator - a model defined in Swagger
        """
    ...
    def credential_stored_on_file(self):
        """
        Gets the credential_stored_on_file of this Ucv1sessionsDataProcessingInformationAuthorizationOptionsInitiator.
        ...
        :return: The credential_stored_on_file of this Ucv1sessionsDataProcessingInformationAuthorizationOptionsInitiator.
        :rtype: bool
        """
    ...
    def credential_stored_on_file(self, credential_stored_on_file):
        """
        Sets the credential_stored_on_file of this Ucv1sessionsDataProcessingInformationAuthorizationOptionsInitiator.
        Store the credential on file<br><br>  Optional field: This field cannot be configured through the Merchant Experience screens in the Business Center, but if required should be provided on a per‑transaction basis in the uc/v1/sessions API request. 

        :param credential_stored_on_file: The credential_stored_on_file of this Ucv1sessionsDataProcessingInformationAuthorizationOptionsInitiator.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Ucv1sessionsDataProcessingInformationAuthorizationOptionsInitiator):
            return False
