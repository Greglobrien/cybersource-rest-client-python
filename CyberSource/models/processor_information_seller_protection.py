...
class ProcessorInformationSellerProtection(object):
    """
    ...
    def __init__(self, type=None, eligibility=None, dispute_categories=None, eligibility_type=None):
        """
        ProcessorInformationSellerProtection - a model defined in Swagger
        """
    ...
    def type(self):
        """
        Gets the type of this ProcessorInformationSellerProtection.
        ...
        :return: The type of this ProcessorInformationSellerProtection.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this ProcessorInformationSellerProtection.
        The kind of seller protection in force for the transaction. This field is returned only when the protection eligibility value is set to ELIGIBLE or PARTIALLY_ELIGIBLE. Possible values - ITEM_NOT_RECEIVED_ELIGIBLE: Sellers are protected against claims for items not received. - UNAUTHORIZED_PAYMENT_ELIGIBLE: Sellers are protected against claims for unauthorized payments. One or both values can be returned. 

        :param type: The type of this ProcessorInformationSellerProtection.
        :type: str
        """
    ...
    def eligibility(self):
        """
        Gets the eligibility of this ProcessorInformationSellerProtection.
        ...
        :return: The eligibility of this ProcessorInformationSellerProtection.
        :rtype: str
        """
    ...
    def eligibility(self, eligibility):
        """
        Sets the eligibility of this ProcessorInformationSellerProtection.
        Indicates whether the transaction is eligible for seller protection. The values returned are described below. Possible values: - `ELIGIBLE` - `PARTIALLY_ELIGIBLE` - `INELIGIBLE` - `NOT_ELIGIBLE` 

        :param eligibility: The eligibility of this ProcessorInformationSellerProtection.
        :type: str
        """
    ...
    def dispute_categories(self):
        """
        Gets the dispute_categories of this ProcessorInformationSellerProtection.
        An array of conditions that are covered for the transaction. 

        :return: The dispute_categories of this ProcessorInformationSellerProtection.
        :rtype: list[str]
        """
    ...
    def dispute_categories(self, dispute_categories):
        """
        Sets the dispute_categories of this ProcessorInformationSellerProtection.
        An array of conditions that are covered for the transaction. 

        :param dispute_categories: The dispute_categories of this ProcessorInformationSellerProtection.
        :type: list[str]
        """
    ...
    def eligibility_type(self):
        """
        Gets the eligibility_type of this ProcessorInformationSellerProtection.
        ...
        :return: The eligibility_type of this ProcessorInformationSellerProtection.
        :rtype: str
        """
    ...
    def eligibility_type(self, eligibility_type):
        """
        Sets the eligibility_type of this ProcessorInformationSellerProtection.
        The kind of seller protection in force for the transaction. This field is returned only when the protection_eligibility property is set to ELIGIBLE or PARTIALLY_ELIGIBLE. Possible values: - `ITEM_NOT_RECEIVED_ELIGIBLE: Sellers are protected against claims for items not received.` - `UNAUTHORIZED_PAYMENT_ELIGIBLE: Sellers are protected against claims for unauthorized payments.` One or both values can be returned. 

        :param eligibility_type: The eligibility_type of this ProcessorInformationSellerProtection.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ProcessorInformationSellerProtection):
            return False
