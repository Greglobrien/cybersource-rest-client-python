...
class ProcessingInfoAuthorizationOptionsInitiator(object):
    """
    ...
    def __init__(self, type=None, credential_stored_on_file=None, stored_credential_used=None, merchant_initiated_transaction=None):
        """
        ProcessingInfoAuthorizationOptionsInitiator - a model defined in Swagger
        """
    ...
    def type(self):
        """
        Gets the type of this ProcessingInfoAuthorizationOptionsInitiator.
        ...
        :return: The type of this ProcessingInfoAuthorizationOptionsInitiator.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this ProcessingInfoAuthorizationOptionsInitiator.
        This field indicates whether the transaction is a merchant-initiated transaction or customer-initiated transaction.  Valid values: - **customer** - **merchant** 

        :param type: The type of this ProcessingInfoAuthorizationOptionsInitiator.
        :type: str
        """
    ...
    def credential_stored_on_file(self):
        """
        Gets the credential_stored_on_file of this ProcessingInfoAuthorizationOptionsInitiator.
        ...
        :return: The credential_stored_on_file of this ProcessingInfoAuthorizationOptionsInitiator.
        :rtype: bool
        """
    ...
    def credential_stored_on_file(self, credential_stored_on_file):
        """
        Sets the credential_stored_on_file of this ProcessingInfoAuthorizationOptionsInitiator.
        Indicates to the issuing bank two things: - The merchant has received consent from the cardholder to store their card details on file - The merchant wants the issuing bank to check out the card details before the merchant initiates their first transaction for this cardholder. The purpose of the merchant-initiated transaction is to ensure that the cardholder's credentials are valid (that the card is not stolen or has restrictions) and that the card details are good to be stored on the merchant's file for future transactions.  Valid values: - `true` means merchant will use this transaction to store payment credentials for follow-up merchant-initiated transactions. - `false` means merchant will not use this transaction to store payment credentials for follow-up merchant-initiated transactions.  **NOTE:** The value for this field does not correspond to any data in the TC 33 capture file5.  This field is supported only for Visa transactions on CyberSource through VisaNet. 

        :param credential_stored_on_file: The credential_stored_on_file of this ProcessingInfoAuthorizationOptionsInitiator.
        :type: bool
        """
    ...
    def stored_credential_used(self):
        """
        Gets the stored_credential_used of this ProcessingInfoAuthorizationOptionsInitiator.
        ...
        :return: The stored_credential_used of this ProcessingInfoAuthorizationOptionsInitiator.
        :rtype: bool
        """
    ...
    def stored_credential_used(self, stored_credential_used):
        """
        Sets the stored_credential_used of this ProcessingInfoAuthorizationOptionsInitiator.
        Indicates to an issuing bank whether a merchant-initiated transaction came from a card that was already stored on file.  Possible values: - **true** means the merchant-initiated transaction came from a card that was already stored on file. - **false**  means the merchant-initiated transaction came from a card that was not stored on file. 

        :param stored_credential_used: The stored_credential_used of this ProcessingInfoAuthorizationOptionsInitiator.
        :type: bool
        """
    ...
    def merchant_initiated_transaction(self):
        """
        Gets the merchant_initiated_transaction of this ProcessingInfoAuthorizationOptionsInitiator.

        :return: The merchant_initiated_transaction of this ProcessingInfoAuthorizationOptionsInitiator.
        :rtype: ProcessingInfoAuthorizationOptionsInitiatorMerchantInitiatedTransaction
        """
    ...
    def merchant_initiated_transaction(self, merchant_initiated_transaction):
        """
        Sets the merchant_initiated_transaction of this ProcessingInfoAuthorizationOptionsInitiator.

        :param merchant_initiated_transaction: The merchant_initiated_transaction of this ProcessingInfoAuthorizationOptionsInitiator.
        :type: ProcessingInfoAuthorizationOptionsInitiatorMerchantInitiatedTransaction
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ProcessingInfoAuthorizationOptionsInitiator):
            return False
