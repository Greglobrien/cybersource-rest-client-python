...
class UcConfigurationsFeaturesPaze(object):
    """
    ...
    def __init__(self, financial_institution=None, financial_institution_contract=None, paze_enabled_in_profile=None):
        """
        UcConfigurationsFeaturesPaze - a model defined in Swagger
        """
    ...
    def financial_institution(self):
        """
        Gets the financial_institution of this UcConfigurationsFeaturesPaze.
        Indicates the financial institution with whom the contract has been signed  Possible values: - BANKOFAMERICA - WELLSFARGO

        :return: The financial_institution of this UcConfigurationsFeaturesPaze.
        :rtype: str
        """
    ...
    def financial_institution(self, financial_institution):
        """
        Sets the financial_institution of this UcConfigurationsFeaturesPaze.
        Indicates the financial institution with whom the contract has been signed  Possible values: - BANKOFAMERICA - WELLSFARGO

        :param financial_institution: The financial_institution of this UcConfigurationsFeaturesPaze.
        :type: str
        """
    ...
    def financial_institution_contract(self):
        """
        Gets the financial_institution_contract of this UcConfigurationsFeaturesPaze.
        Indicates if the contract has been signed with the selected bank

        :return: The financial_institution_contract of this UcConfigurationsFeaturesPaze.
        :rtype: bool
        """
    ...
    def financial_institution_contract(self, financial_institution_contract):
        """
        Sets the financial_institution_contract of this UcConfigurationsFeaturesPaze.
        Indicates if the contract has been signed with the selected bank

        :param financial_institution_contract: The financial_institution_contract of this UcConfigurationsFeaturesPaze.
        :type: bool
        """
    ...
    def paze_enabled_in_profile(self):
        """
        Gets the paze_enabled_in_profile of this UcConfigurationsFeaturesPaze.
        Paze enabled in the profile for the merchants

        :return: The paze_enabled_in_profile of this UcConfigurationsFeaturesPaze.
        :rtype: bool
        """
    ...
    def paze_enabled_in_profile(self, paze_enabled_in_profile):
        """
        Sets the paze_enabled_in_profile of this UcConfigurationsFeaturesPaze.
        Paze enabled in the profile for the merchants

        :param paze_enabled_in_profile: The paze_enabled_in_profile of this UcConfigurationsFeaturesPaze.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UcConfigurationsFeaturesPaze):
            return False
