...
class AgenticUpdatePurchaseIntentRequest(object):
    """
    ...
    def __init__(self, client_correlation_id=None, payment_information=None, device_information=None, assurance_data=None, mandates=None, buyer_information=None, consumer_prompt=None):
        """
        AgenticUpdatePurchaseIntentRequest - a model defined in Swagger
        """
    ...
    def client_correlation_id(self):
        """
        Gets the client_correlation_id of this AgenticUpdatePurchaseIntentRequest.
        Client Correlation Id used during the tokenization or during FIDO assertion.

        :return: The client_correlation_id of this AgenticUpdatePurchaseIntentRequest.
        :rtype: str
        """
    ...
    def client_correlation_id(self, client_correlation_id):
        """
        Sets the client_correlation_id of this AgenticUpdatePurchaseIntentRequest.
        Client Correlation Id used during the tokenization or during FIDO assertion.

        :param client_correlation_id: The client_correlation_id of this AgenticUpdatePurchaseIntentRequest.
        :type: str
        """
    ...
    def assurance_data(self):
        """
        Gets the assurance_data of this AgenticUpdatePurchaseIntentRequest.
        Assurance data.
    ...
    def assurance_data(self, assurance_data):
        """
        Sets the assurance_data of this AgenticUpdatePurchaseIntentRequest.
        Assurance data.
    ...
    def consumer_prompt(self):
        """
        Gets the consumer_prompt of this AgenticUpdatePurchaseIntentRequest.
        Recap - A summary or condensed version of user prompts that leads to the purchase.

        :return: The consumer_prompt of this AgenticUpdatePurchaseIntentRequest.
        :rtype: str
        """
    ...
    def consumer_prompt(self, consumer_prompt):
        """
        Sets the consumer_prompt of this AgenticUpdatePurchaseIntentRequest.
        Recap - A summary or condensed version of user prompts that leads to the purchase.

        :param consumer_prompt: The consumer_prompt of this AgenticUpdatePurchaseIntentRequest.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, AgenticUpdatePurchaseIntentRequest):
            return False
