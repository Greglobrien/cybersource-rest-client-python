...
class Tmsv2tokenizeTokenInformationCustomerEmbedded(object):
    """
    ...
    def __init__(self, default_payment_instrument=None, default_shipping_address=None):
        """
        Tmsv2tokenizeTokenInformationCustomerEmbedded - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tmsv2tokenizeTokenInformationCustomerEmbedded):
            return False
