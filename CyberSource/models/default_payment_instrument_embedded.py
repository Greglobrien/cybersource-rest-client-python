...
class DefaultPaymentInstrumentEmbedded(object):
    """
    ...
    def __init__(self, instrument_identifier=None):
        """
        DefaultPaymentInstrumentEmbedded - a model defined in Swagger
        """
    ...
    def instrument_identifier(self):
        """
        Gets the instrument_identifier of this DefaultPaymentInstrumentEmbedded.

        :return: The instrument_identifier of this DefaultPaymentInstrumentEmbedded.
    ...
    def instrument_identifier(self, instrument_identifier):
        """
        Sets the instrument_identifier of this DefaultPaymentInstrumentEmbedded.

        :param instrument_identifier: The instrument_identifier of this DefaultPaymentInstrumentEmbedded.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, DefaultPaymentInstrumentEmbedded):
            return False
