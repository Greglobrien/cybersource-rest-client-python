...
class RiskAddressVerificationInformation(object):
    """
    ...
    def __init__(self, address_type=None, bar_code=None, applicable_region=None, error_code=None, status_code=None, care_of=None, match_score=None, standard_address=None):
        """
        RiskAddressVerificationInformation - a model defined in Swagger
        """
    ...
    def address_type(self):
        """
        Gets the address_type of this RiskAddressVerificationInformation.
        ...
        :return: The address_type of this RiskAddressVerificationInformation.
        :rtype: str
        """
    ...
    def address_type(self, address_type):
        """
        Sets the address_type of this RiskAddressVerificationInformation.
        Contains the record type of the postal code with which the address was matched.  #### U.S. Addresses Depending on the quantity and quality of the address information provided, this field contains one or two characters:  - One character: sufficient correct information was provided to result in accurate matching. - Two characters: standardization would provide a better address if more or better input address information were available. The second character is D (default).  Blank fields are unassigned. When an address cannot be standardized, how the input data was parsed determines the address type. In this case, standardization may indicate a street, rural route, highway contract, general delivery, or PO box.   #### All Other Countries This field contains one of the following values: - P: Post. - S: Street. - x: Unknown. 

        :param address_type: The address_type of this RiskAddressVerificationInformation.
        :type: str
        """
    ...
    def bar_code(self):
        """
        Gets the bar_code of this RiskAddressVerificationInformation.

        :return: The bar_code of this RiskAddressVerificationInformation.
        :rtype: RiskAddressVerificationInformationBarCode
        """
    ...
    def bar_code(self, bar_code):
        """
        Sets the bar_code of this RiskAddressVerificationInformation.

        :param bar_code: The bar_code of this RiskAddressVerificationInformation.
        :type: RiskAddressVerificationInformationBarCode
        """
    ...
    def applicable_region(self):
        """
        Gets the applicable_region of this RiskAddressVerificationInformation.
        ...
        :return: The applicable_region of this RiskAddressVerificationInformation.
        :rtype: str
        """
    ...
    def applicable_region(self, applicable_region):
        """
        Sets the applicable_region of this RiskAddressVerificationInformation.
        Value can be - Canada - US - International The values of errorCode and statusCode mean different things depending on the applicable region. Refer to the guide for more info. 

        :param applicable_region: The applicable_region of this RiskAddressVerificationInformation.
        :type: str
        """
    ...
    def error_code(self):
        """
        Gets the error_code of this RiskAddressVerificationInformation.
        ...
        :return: The error_code of this RiskAddressVerificationInformation.
        :rtype: str
        """
    ...
    def error_code(self, error_code):
        """
        Sets the error_code of this RiskAddressVerificationInformation.
        Four-character error code returned for Canadian, US and international addresses. For possible values, see Verification Services guide. The meaning of the errorCode depends on value of applicableRegion. 

        :param error_code: The error_code of this RiskAddressVerificationInformation.
        :type: str
        """
    ...
    def status_code(self):
        """
        Gets the status_code of this RiskAddressVerificationInformation.
        ...
        :return: The status_code of this RiskAddressVerificationInformation.
        :rtype: str
        """
    ...
    def status_code(self, status_code):
        """
        Sets the status_code of this RiskAddressVerificationInformation.
        Four-to-ten character status code returned for Canadian, US and international addresses. For possible values, see Verification Services guide. The meaning of the errorCode depends on value of applicableRegion. 

        :param status_code: The status_code of this RiskAddressVerificationInformation.
        :type: str
        """
    ...
    def care_of(self):
        """
        Gets the care_of of this RiskAddressVerificationInformation.
        Care of data dropped from the standard address.

        :return: The care_of of this RiskAddressVerificationInformation.
        :rtype: str
        """
    ...
    def care_of(self, care_of):
        """
        Sets the care_of of this RiskAddressVerificationInformation.
        Care of data dropped from the standard address.

        :param care_of: The care_of of this RiskAddressVerificationInformation.
        :type: str
        """
    ...
    def match_score(self):
        """
        Gets the match_score of this RiskAddressVerificationInformation.
        ...
        :return: The match_score of this RiskAddressVerificationInformation.
        :rtype: int
        """
    ...
    def match_score(self, match_score):
        """
        Sets the match_score of this RiskAddressVerificationInformation.
        Indicates the probable correctness of the address match. Returned for U.S. and Canadian addresses. Returns a value from 0-9, where 0 is most likely to be correct and 9 is least likely to be correct, or -1 if there is no address match. 

        :param match_score: The match_score of this RiskAddressVerificationInformation.
        :type: int
        """
    ...
    def standard_address(self):
        """
        Gets the standard_address of this RiskAddressVerificationInformation.

        :return: The standard_address of this RiskAddressVerificationInformation.
        :rtype: RiskAddressVerificationInformationStandardAddress
        """
    ...
    def standard_address(self, standard_address):
        """
        Sets the standard_address of this RiskAddressVerificationInformation.

        :param standard_address: The standard_address of this RiskAddressVerificationInformation.
        :type: RiskAddressVerificationInformationStandardAddress
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RiskAddressVerificationInformation):
            return False
