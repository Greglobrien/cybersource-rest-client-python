...
from CyberSource.apis.agent_capabilities_api import AgentCapabilitiesApi


class TestAgentCapabilitiesApi(unittest.TestCase):
    """ AgentCapabilitiesApi unit test stubs """

    def setUp(self):
        self.api = CyberSource.apis.agent_capabilities_api.AgentCapabilitiesApi()
