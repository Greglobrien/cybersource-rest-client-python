...
**source** | **str** | Source of the card details. Possible Values: - CONTACTLESS_TAP  | [optional] 
...
**point_of_sale_information** | [**TmsPointOfSaleInformation**](TmsPointOfSaleInformation.md) |  | [optional] 
