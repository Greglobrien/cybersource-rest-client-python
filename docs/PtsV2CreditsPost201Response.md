...
**status** | **str** | The status of the submitted transaction.  Possible values:  - PENDING  - AUTHORIZED  - DECLINED  - INVALID_REQUEST  - COMPLETED (as in the case of PIN Debit Full Financial Credit)  | [optional] 
