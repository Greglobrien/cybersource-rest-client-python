...
**status** | **str** | The status of the submitted transaction.  Possible values:  - FORBIDDEN_ACCESS  | [optional] 
**reason** | **str** | The reason of the status.  Possible values:  - FORBIDDEN_ACCESS  | [optional] 
